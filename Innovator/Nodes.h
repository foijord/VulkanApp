...
public:
  ...
  Volume()
  {
    ...
    this->children = {
      ...
      std::make_shared<DescriptorSetLayoutBinding>(0, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK_SHADER_STAGE_FRAGMENT_BIT),

      //std::make_shared<TransformBuffer>(),
      //std::make_shared<DescriptorSetLayoutBinding>(1, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK_SHADER_STAGE_VERTEX_BIT),
